...
const CONTENT = {
    terms: {
        ...
        sections: [
            ...
            { heading: '4. Cancellations', body: 'A booking can be cancelled free of charge until a driver has accepted it. Once a driver has accepted, please contact support@ridex.com to cancel; refunds for cancelled journeys are handled case by case.' },
