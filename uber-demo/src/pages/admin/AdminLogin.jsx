    ...
    <div className="min-h-screen bg-black flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4">
        <div className="w-full max-w-sm">
          ...
          {/* Misconfiguration warning — shown if env var is missing */}
          {!ADMIN_EMAIL && (
            <div className="bg-yellow-500/10 border border-yellow-500/30 text-yellow-400 text-sm rounded-xl px-4 py-3 mb-4">
              <p className="font-bold mb-0.5">Setup required</p>
              <p className="text-xs text-yellow-300/80">
                Add <code className="bg-yellow-400/10 px-1 rounded">REACT_APP_ADMIN_EMAIL</code> to your <code className="bg-yellow-400/10 px-1 rounded">.env.local</code> file and restart the dev server.
              </p>
            </div>
          )}
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-black border border-gray-800 rounded-xl px-4 py-3 pr-10 text-white text-sm focus:outline-none focus:border-yellow-400 transition"
                  />
                  <button
                    type="button"
